...
**Новые возможности:**
* Добавлена опциональная возможность запретить спавн составов не оборудованных АЛС или не показывающих предупредительную частоту на картах с сигнализацией 2/6
