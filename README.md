...
* **metrostroi_advanced_timezone 3** //часовой пояс сервера, по умолчанию 3 (Московское время)
* **metrostroi_advanced_buttonmessage 0** //вкл(1)/выкл(0) уведомления в чат о нажатии игроками кнопок на пультах
